// Contract tests for the Budget CSV export. Negative amounts must stay numeric:
// escapeCsvField's formula guard matches a leading "-", so routing amounts
// through it would turn a numeric cell into text.
