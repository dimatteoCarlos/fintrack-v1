// Contract tests for the hero section. The first guards the sign trap: the by-type endpoint emits the
// payable leg negative but the contract declares a positive magnitude; reversed, a subtraction becomes
// an addition and net worth minus liquid net worth stops equalling the receivable leg.
