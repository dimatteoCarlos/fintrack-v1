// State of the transaction detail modal: which transaction is open, whether it is
// still loading, and how it failed. Shared so any list can open the same modal.
