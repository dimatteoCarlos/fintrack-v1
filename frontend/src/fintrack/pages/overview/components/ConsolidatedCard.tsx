// The consolidated "all" card of level 1: net worth, four figures, the month's movement count.
// Folds through CollapsibleBlock like the domain cards; no drill link, since no level-2 "all" screen exists.
