// Collapsible card of the hero's four narrower figures, closed by default. Order is the narrowing: each
// position takes a term out of the one above; net monthly flow is last as the only flow. Each definition
// restates makeHeroSection.js so a tip cannot describe a figure the server does not publish.
