// Big results box for the overview: one title and amount row per entry.
// Rendered by OverviewLayout.tsx.

import { currencyFormat } from '../../../helpers/functions';
import { CURRENCY_OPTIONS, DEFAULT_CURRENCY } from '../../../helpers/constants';

// The grouping and decimal marks, which are a LOCALE and not a currency: the
// currency arrives with the figures, so a payload in another accounting currency
// is never printed under DEFAULT_CURRENCY's symbol.
...
type BigBoxResultPropType = {
  ...
  // hero.currency, from the payload. null before the first answer, which is the
  // same moment every amount is null - so no row is ever formatted without it.
