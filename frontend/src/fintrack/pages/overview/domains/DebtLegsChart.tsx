...
// Receivable first; the words are the level-1 card's. The tone colours the figure
// only, as on the counterparty rows; the plots keep one ink (TrendChart is inked
// for the dark ground instead).
const LEGS: {
...
function DebtLegsChart({ legs, currency }: DebtLegsChartProps) {
 ...
 // which per-series scales (as TrendChart uses) would hide.
 const peak = Math.max(
