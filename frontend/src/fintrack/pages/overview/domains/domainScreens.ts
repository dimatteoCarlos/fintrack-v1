// The six level-2 screens: reader-facing name, headline figure and composition per domain.
...
export const DOMAIN_SCREENS: DomainScreens = {
 ...
 investment: {
  ...
  headline: { nature: 'closing balance', amountOf: (card) => card.ledgerBalance },
  list: MOVEMENTS_LIST,
 ...
 debt: {
  ...
  headline: { nature: 'closing balance', amountOf: (card) => card.totalAmount },
  list: MOVEMENTS_LIST,
