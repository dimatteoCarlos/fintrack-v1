// One level-2 analysis section; it owns the three fetch states so a domain draws only ready content.
...
// For a list whose card publishes no count, income among them.
