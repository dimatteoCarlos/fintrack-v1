// Presentational profile form; state and API calls live in UpdateProfileContainer.
  ...
  return (
    <div className={`${styles.formContainer} ${className}`}>
      ...
      <div className={styles.messagesContainer}>
        ...
        {/* Field errors take precedence over the API-level message */}
      ...
      >
        ...
        {/* Debug tools: development only, hidden after a successful save */}
